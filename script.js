const materias = [
  ...
  },
  {
    ...
    materias: [
      ...
      { codigo: "ING178", uv: 2, nombre: "Inglés I", electiva: false, prerequisitos: ["MAT278"] },
...
// Función para verificar si están aprobados todos los prerequisitos
function tienePrerequisitosAprobados(prereqs) {
  if (!prereqs || prereqs.length === 0) return true;
  return prereqs.every((codigo) => estadoMaterias[codigo]);
}

// Actualiza el estado visual de materias bloqueadas o desbloqueadas
...
// Crear elementos HTML para la malla
